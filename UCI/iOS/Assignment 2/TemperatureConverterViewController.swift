...
class TemperatureConverterViewController: UIViewController, UITextFieldDelegate {
    ...
    required init(coder aDecoder: NSCoder) {
        ...
        super.init(coder: aDecoder)! // make forced failability
    ...
    func textFieldShouldReturn(textField: UITextField) -> Bool
    {
        ...
        if textField == fahrenheitTextField
        {
            ...
            let fahrenheitTemp: Double = (fahrenheitTextField.text! as NSString).doubleValue // Changed to force unwrap textfield.text before casting 1/17/2016
        ...
        if textField == celsiusTextField
        {
            ...
            let celsiusTemp: Double = (celsiusTextField.text! as NSString).doubleValue // Changed to force unwrap textfield.text before casting 1/17/2016
